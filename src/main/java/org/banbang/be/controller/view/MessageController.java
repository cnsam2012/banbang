...
public class MessageController {
    ...
    private static String TOPIC_COMMNET = BbKafkaTopic.TOPIC_COMMNET.value();
    private static String TOPIC_LIKE = BbKafkaTopic.TOPIC_LIKE.value();
    private static String TOPIC_FOLLOW   = BbKafkaTopic.TOPIC_FOLLOW.value();
